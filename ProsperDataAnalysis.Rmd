...
ggplot(aes(x=interest_diff), data=sub) + 
  ...
  geom_vline(xintercept = median(sub$interest_diff), linetype=1, color='blue') +
  geom_vline(xintercept = quantile(sub$interest_diff, probs=0.1), linetype=2, color='blue') +
  geom_vline(xintercept = quantile(sub$interest_diff, probs=0.9), linetype=2, color='blue')
